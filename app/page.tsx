      ...
      <main className="relative z-10 mx-auto flex w-full max-w-6xl flex-1 flex-col gap-24 px-6 pb-24 pt-10">
        <section className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="relative">
            <div className="absolute inset-0 rotate-3 rounded-[32px] bg-brand-200/60" />
            <div className="relative flex h-full flex-col gap-6 rounded-[32px] border border-brand-100 bg-white/90 p-8 shadow-[0_25px_60px_rgba(10,77,56,0.16)]">
              ...
              <div className="flex flex-1 items-center justify-center rounded-3xl border border-dashed border-brand-200 bg-brand-50 p-8">
                <div className="grid h-44 w-44 place-items-center rounded-2xl bg-white shadow-inner">
                  <div className="h-28 w-28 rounded-lg bg-[conic-gradient(from_90deg,rgba(21,184,121,0.2),rgba(21,184,121,0.9),rgba(21,184,121,0.2))]" />
                </div>
              </div>
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="rounded-2xl bg-brand-900 px-4 py-3 text-white">
